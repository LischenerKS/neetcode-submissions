class Solution {
    public void solve(char[][] board) {
        ...
        // пройдем по краям доски и найдем там ошки
        // от всех ошек будем делать поиск в ширину одновременно и отмечать соединенные как недоступные для захвата
        // пройдем по всем доступным и сделаем иксами
