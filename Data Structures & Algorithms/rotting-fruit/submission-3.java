class Solution {
    ...
    // ищем все гнилые
    // и считаем кол-во не гнилых
    // делаем одновременно поиск в ширину от всех гнилых
    // каждый шаг - минута, декрементируем счетчик для каждого загнивания

    // когда очередь на поиск в ширину закончится
    // если счетчик не ноль, то ответ -1
    // если ноль, то текущий уровень поиска в ширину
